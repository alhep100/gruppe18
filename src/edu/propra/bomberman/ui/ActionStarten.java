...
public class ActionStarten extends AbstractAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		Jukebox ah = new Jukebox();
		
		ah.playSound(5);
		Bomberman.gameFrame.setVisible(false);
		SGPanel panel = Bomberman.gameFrame.gameEngine.getGraphicEngine()
				.getPanel();
		Bomberman.gameFrame.setContentPane(panel);
		Bomberman.gameFrame.gameEngine.initializeGame();
		Bomberman.gameFrame.addKeyListener(Bomberman.gameFrame.gameEngine
				.getUserControlEngine());
